...
})({"dBXSV":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
async function init() {
    ...
    _buttonsDefault.default(_gameState.handleUserAction);
...
const gameState = {
    ...
    wake () {
        ...
        _ui.modScene(_constants.SCENES[this.scene]);
        this.sleepTime = this.clock + _constants.DAY_LENGTH;
        this.hungryTime = _constants.getNextHungerTime(this.clock);
    ...
    getHungry () {
        this.current = "HUNGRY";
        this.dieTime = _constants.getNextDieTime(this.clock);
        this.hungryTime = -1;
        _ui.modFox("hungry");
    },
    poop () {
    ...
    die () {
        ...
        _ui.modFox("dead");
        this.clearTimes();
        _ui.writeModal("The fox died :( <br/> Press the middle button to start");
    },
    startCelebrating () {
        this.current = "CELEBRATING";
        _ui.modFox("celebrate");
        this.timeToStartCelebrating = -1;
    ...
    endCelebrating () {
        ...
        this.current = "IDLING";
        this.determineFoxState();
        _ui.togglePoopBag(false);
    },
    determineFoxState () {
        if (this.current === "IDLING") {
            if (_constants.SCENES[this.scene] === "rain") _ui.modFox("rain");
            else _ui.modFox("idling");
        }
    },
    ...
    feed () {
        ...
        this.dieTime = -1;
        this.poopTime = _constants.getNextPoopTime(this.clock);
        _ui.modFox("eating");
...
function initButtons(handleUserAction) {
    ...
    function buttonClick({ target  }) {
        if (target.classList.contains("left-btn")) {
            ...
            toggleHighlighted(selectedIcon, true);
        } else handleUserAction(_constants.ICONS[selectedIcon]);
    }
    document.querySelector(".buttons").addEventListener("click", buttonClick);
}
exports.default = initButtons;

},{"./constants":"3huJa","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["dBXSV","hBLPf"], "hBLPf", "parcelRequire18f0")
